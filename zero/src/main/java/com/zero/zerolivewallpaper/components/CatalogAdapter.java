...
public class CatalogAdapter extends BaseAdapter {
    ...
    public void setContent(List<CatalogItem> itemList) {
        ...
        Log.d("TAG", "setContent===>: "+ itemList.toString());
...
//        notifyDataSetInvalidated();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.d("TAG", "getView: "+ itemList.get(0).getTitle());
        Log.d("TAG", "getView: "+ itemList.get(0).getAuthor());
        ...
        Log.d("TAG", "getView: "+thumbnailUrl.toString() );
        Glide.with(context)
                .load(thumbnailUrl)
